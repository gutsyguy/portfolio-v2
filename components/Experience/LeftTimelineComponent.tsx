    ...
    >
      <div className="flex flex-col sm:flex-row items-center">
        <div className="flex justify-start w-full mx-auto items-center">
          ...
          >
            <div
              className="p-4 bg-[#BCCCDC] dark:bg-gray-800 rounded shadow dark:text-white border-solid dark:border-gray-600 border-gray-700 border-2 transform transition-all duration-500"
        ...
        <div className="rounded-full bg-[#BCCCDC] dark:bg-gray-800 border-gray-600 dark:border-gray-600 border-4 w-8 h-8 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center">
          <svg
