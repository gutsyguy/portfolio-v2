    ...
    >
      <div className="flex flex-col sm:flex-row items-center">
        <div className="flex justify-end w-full mx-auto items-center">
          ...
          >
            <div
              className="p-4 bg-[#BCCCDC] dark:bg-gray-800 rounded shadow dark:border-gray-600 dark:text-white border-solid border-gray-700 border-2 transform transition-all duration-500"
              onMouseEnter={handleHoverTrue}
              onMouseLeave={handleHoverFalse}
            >
              <div>
                <h1 className="text-xl text-[#D9EAFD] dark:text-blue-300 drop-shadow-[0_1.2px_1.2px_rgba(0,0,0,0.4)]">
                  {props.company}
                </h1>
        ...
        <div className="rounded-full dark:bg-gray-800 bg-[#BCCCDC] border-gray-700 dark:border-gray-600 border-4 w-8 h-8 absolute left-1/2 -translate-y-4 sm:translate-y-0 transform -translate-x-1/2 flex items-center justify-center">
          <svg
