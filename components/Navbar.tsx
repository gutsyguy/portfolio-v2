        ...
        >
          <ul className="font-medium flex flex-col p-4 md:p-0 mt-4  rounded-lg md:flex-row md:space-x-8 rtl:space-x-reverse md:mt-0 md:border-0 dark:border-gray-700">
            <li>
              <Link
                href="/"
                className="block text-black dark:text-white py-2 px-3 rounded md:bg-transparent md:p-0"
                aria-current="page"
              >
                Home
              </Link>
            ...
            <button
              className={`round-xl mb-[0.5rem] px-[0.75rem] text-start text-gray-800 dark:text-white `}
